		...
		<div class="bg-primary bg-gradient-to-b from-primary to-primary-gradient text-white">
			<div class="grid grid-cols-12">
				...
				<div class="col-span-12 md:col-span-6">
					<div class="relative">
						<div class="half-content-groomsmen-header">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="bg-primary text-white">
			<div class="grid grid-cols-12">
				<div class="col-span-12 text-center py-10">
					<h1 class="body-font text-3xl uppercase pb-10">See You There?</h1>
...
import { groomsmen, tagline, RSVP } from '~/data/data.json'
export default {
    name: 'MeetTheGroomsmen',
...
@media screen and (min-width: 40em) {
	.half-content-groomsmen-header {
		background: url('~static/images/groomsmen/groomsmen-head.jpg');
		height: 75vh;
